...
function Signup() {
  ...
  console.log("Loading state in Signup component:", loadingAuth);
  ...
  const create = async (data) => {
    ...
    dispatch(setLoadingAuth()); // Start loading state
    try {
      ...
      dispatch(unSetLoadingAuth()); // End loading state
    }
  };
          ...
          <form onSubmit={handleSubmit(create)}>
            <div className='space-y-5'>
              ...
              <Button type='submit' className='w-full' disabled={loadingAuth}>
                {loadingAuth ? (
                  <div className='flex items-center justify-center'>
                    <LoadingSpinner className="h-5 w-5 mr-2" /> {/* Add spinner here */}
                    Creating Account...
                  </div>
                ) : (
                  "Create Account"
