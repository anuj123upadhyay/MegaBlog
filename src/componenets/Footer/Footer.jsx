...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p className="mt-4 max-w-xs text-gray-500">
          MegaBlog is a blog post website user by beginners and creators staring out on their Journey.
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="/features" className="text-gray-700 transition hover:opacity-75"> Features </a>
            </li>

            <li>
              <a href="/pricing" className="text-gray-700 transition hover:opacity-75"> Pricing </a>
            </li>

            <li>
              <a href="/affiliate-program" className="text-gray-700 transition hover:opacity-75"> Affiliate Program </a>
            </li>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="/contributors" className="text-gray-700 transition hover:opacity-75"> Meet the Team </a>
            </li>

            <li>
              <a href="/presskit" className="text-gray-700 transition hover:opacity-75"> Press Kit </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="/frequently-asked-questions" className="text-gray-700 transition hover:opacity-75"> FAQs </a>
            </li>
            ...
            <li>
              <a href="/customer-support" className="text-gray-700 transition hover:opacity-75"> Customer Support </a>
            </li>

            <li>
              <a href="/Feedback" className="text-gray-700 transition hover:opacity-75"> Feedback </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="/termsandconditions" className="text-gray-700 transition hover:opacity-75"> Terms & Conditions </a>
            </li>
            ...
            <li>
              <a href="/licensing" className="text-gray-700 transition hover:opacity-75"> Licensing </a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <p className="text-xs text-gray-500">&copy; 2024. MegaBlog. All rights reserved.</p>
  </div>
</footer>
    </>
  );
