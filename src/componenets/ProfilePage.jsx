...
const ProfilePage = () => {
    ...
    const handleSaveDraft = () => {
        if (newDraftTitle.trim() && newDraftDetails.trim()) {
            setDrafts([...drafts, { title: newDraftTitle, details: newDraftDetails }]);
            setNewDraftTitle('');
            setNewDraftDetails('');
        }
    };
        ...
        <div className="w-4/5 mx-auto p-6 pb-20">
            <div className='flex w-full justify-between'>
                ...
                <div className="mt-6 p-6 bg-white rounded-lg shadow-md w-3/5">
                    ...
                    <p className="text-gray-600 mb-6">Update your profile settings below.</p>
                ...
                <ul className="space-y-3">
                    {drafts.length > 0 ? (
                        drafts.map((draft, index) => (
                            ...
                            >
                                <span className="text-gray-700 font-medium"> <span className='font-bold text-lg'>{index + 1} {draft.title}</span><br />{draft.details}</span>
                                <button
